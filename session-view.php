          ...
          <div class="card-body">
            ...
            if (isset($_GET['idsessao'])) {
              ...
              $query = "SELECT  titulopt, sinopse,tiposessao,sigla,classificacao,tituloen,nomediretor,
                            nomegenero,nomeator,nomesala,duracao,capacidade, nomepais 
                            FROM sessoes join filmes on sessoes.idfilme = filmes.idfilme  
                            join diretores on diretores.iddiretor = filmes.iddiretor 
                            join filmes_generos on filmes.idfilme = filmes_generos.idfilme 
                            join Generos on filmes_generos.idgenero = generos.idgenero
                            join elenco on elenco.idfilme = filmes.idfilme
                            join atores on atores.idator = elenco.idator
