...
<?php include('message.php'); ?>
  <div class="card-header">Filmes Em Cartaz</div>
  <div class="card-body">
...
<table class="table table-dark table-hover">
  ...
  <tbody>
    ...
    <?php 
        ...
        $query = "SELECT idfilme,titulopt,anolancamento,classificacao,duracao,datain,dataf FROM filmes order by idfilme ";
...
<a href="create-movie.php" class="btn btn-light">Cadastrar novo filme</a>
