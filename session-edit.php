            ...
            ?>
                ...
                <form action="code.php" method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="date" id="datasessao" name="datasessao"value="<?= $sessoes['datasessao']; ?>" class="form-control">
                  </div>
                  
                  <div class="mb-3">
                    <label>Horário da Sessão</label>
                    <select class="form-select" id="horario" name="horario" aria-label="Default select example">
                    <option selected value="<?= $sessoes['idhorario']; ?>"><?php echo $sessoes['horario'] ?></option>
